...
class Task2:
    def __init__(self,args):
        ...
        if self.arg.test:
            ...
            self.saver.restore(self.sess,'Matching/39_1')
    ...
    def pre_novel(self):
        ...
        #np.save('sample_5_shot.npy',sample_id)
        sample_id = np.load('sample_5_shot.npy')
    ...
    def test_next_batch(self,num=0,cls_num=None):
        ...
        for _ in range(100):#100
            ...
            for i , c  in enumerate(classes):
                #for ic in classes:
                samples = np.random.permutation(5)[:self.K]##5
                for s in samples : 
    ...
    def train(self):
        ...
        for i in range(epochs):
            ...
            if acc_1 > 0.85 : 
                self.saver.save(self.sess,'Matching/'+str(i))
